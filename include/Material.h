...
class Lambertian : public Material {
  public:
    ...
    bool Scatter(const Ray&, const HitRecord& rec, Color& attenuation, Ray& ray_scattered) const override {
...
class Metal : public Material {
  public:
    ...
    bool Scatter(const Ray& ray_in, const HitRecord& rec, Color& attenuation, Ray& ray_scattered) const override {
...
class Dielectric : public Material {
  public:
    ...
    bool Scatter(const Ray& r_in, const HitRecord& rec, Color& attenuation, Ray& ray_scattered) const override {
